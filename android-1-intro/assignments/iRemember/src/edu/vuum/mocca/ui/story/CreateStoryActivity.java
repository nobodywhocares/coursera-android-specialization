...
public class CreateStoryActivity extends StoryActivityBase {
	...
	private void launchCameraIntent() {
		...
		// getOutputMediaFile to create a new filename for this specific image;
                Uri mediaFile = getOutputMediaFileUri(MEDIA_TYPE_IMAGE);
                // TOMO determine why data.getData() is null after image capture in emulator but NOT in my
                // Samsung Galaxy SIII ... meanwhile this direct assignment as well as populating intent
                // with the actual Uri and not Path
                fragment.imagePath = mediaFile;
	...
	private void launchVideoCameraIntent() {
		...
		String mediaFile = getOutputMediaFileUri(MEDIA_TYPE_VIDEO).getPath();
